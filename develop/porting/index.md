...
resources:
  ...
  https://docs.neoforged.net/primer/docs/26.3/: ChampionAsh5357's 26.2 -> 26.3 Migration Primers
---
...
- [NeoForge's _Minecraft 26.2 -> 26.3 Mod Migration Primer_](https://docs.neoforged.net/primer/docs/26.3/) covers migrating from 26.2 to 26.3, focusing only on vanilla code changes.
