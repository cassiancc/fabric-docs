...
authors-nogithub:
  ...
  - tao0lu
resources:
  https://docs.neoforged.net/docs/items/mobeffects: Ефекти моба — Документація NeoForge (крім зіль)
---
...
@[code lang=java transcludeWith=:::1](@/reference/26.1.2/src/main/java/com/example/docs/effect/TaterEffect.java)
...
@[code lang=java transcludeWith=:::1](@/reference/26.1.2/src/main/java/com/example/docs/effect/ExampleModEffects.java)
...
@[code lang=java transcludeWith=:::1](@/reference/26.1.2/src/main/java/com/example/docs/ReferenceMethods.java)
