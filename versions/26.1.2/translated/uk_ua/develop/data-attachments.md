...
API вкладення даних, наданий API Fabric, дозволяє розробникам легко приєднувати довільні дані до сутностей, блоків-сутностей, рівнів і чанків. Укладені дані можна зберігати та синхронізувати за допомогою кодеків [кодеків](./codecs) і [потоків кодеків](https://docs.neoforged.net/docs/networking/streamcodecs/), тому вам слід ознайомитися з ними перед використанням.
...
@[code lang=java transcludeWith=:::string](@/reference/26.1.2/src/main/java/com/example/docs/attachment/ExampleModAttachments.java)
...
@[code lang=java transcludeWith=:::pos](@/reference/26.1.2/src/main/java/com/example/docs/attachment/ExampleModAttachments.java)
...
@[code lang=java transcludeWith=:::persistent](@/reference/26.1.2/src/main/java/com/example/docs/attachment/ExampleModAttachments.java)
...
@[code lang=java transcludeWith=:::stamina](@/reference/26.1.2/src/main/java/com/example/docs/attachment/Stamina.java)
