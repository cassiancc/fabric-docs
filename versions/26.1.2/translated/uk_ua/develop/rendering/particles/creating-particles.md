...
Ви можете побачити всі фабрики частинок, переглянувши всі реалізації інтерфейсу `ParticleProvider`. Це корисно, якщо ви хочете використовувати поведінку іншої частинки для своєї власної частинки.
