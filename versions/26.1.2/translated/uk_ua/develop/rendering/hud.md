...
description: Дізнайтеся, як використовувати API Fabric Hud для рендера HUD.
authors:
  - IMB11
  - kevinthegreat1
---

Ми вже коротко торкалися рендера речей у HUD на сторінці [основних концепцій рендера](./basic-concepts) і [використання малювання в GUI](./gui-graphics), тому на цій сторінці ми будемо дотримуватись API Hud і параметра `DeltaTracker`.
...
Графіку GUI можна використовувати для доступу до різноманітних утиліт рендера, які надає гра, і доступу до стека необроблених матриць. Щоб дізнатися більше про них, перегляньте сторінку [малювання в GUI](./gui-graphics).
