...
Оскільки модифікація Minecraft покладається на інструменти модифікації байт-коду під час виконання, такі як міксин, просто додавання та використання JUnit зазвичай не спрацює. Ось чому Fabric надає Fabric Loader JUnit, плаґін JUnit, який дає змогу проводити модульне тестування в Minecraft.
...
@[code transcludeWith=:::automatic-testing:2](@/reference/26.1.2/build.gradle)
...
@[code lang=java transcludeWith=:::automatic-testing:4](@/reference/26.1.2/src/test/java/com/example/docs/codec/BeanTypeTest.java)
...
@[code lang=java transcludeWith=:::automatic-testing:7](@/reference/26.1.2/src/test/java/com/example/docs/codec/BeanTypeTest.java)

### Налаштування GitHub Actions {#setting-up-github-actions}

::: info

У цьому розділі передбачається, що ви використовуєте стандартний робочий процес GitHub Action, який входить до прикладу мода та шаблону мода.
...
@[code transcludeWith=:::automatic-testing:game-test:1](@/reference/26.1.2/build.gradle)
...
<<< @/reference/26.1.2/src/gametest/resources/fabric.mod.json
...
<<< @/reference/26.1.2/src/gametest/java/com/example/docs/ExampleModGameTest.java [Server]

<<< @/reference/26.1.2/src/gametest/java/com/example/docs/ExampleModClientGameTest.java [Client]
...
@[code transcludeWith=:::automatic-testing:game-test:2](@/reference/26.1.2/build.gradle)
