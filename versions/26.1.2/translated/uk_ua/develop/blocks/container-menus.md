...
@[code transcludeWith=:::block](@/reference/26.1.2/src/main/java/com/example/docs/block/custom/DirtChestBlock.java)

@[code transcludeWith=:::be](@/reference/26.1.2/src/main/java/com/example/docs/block/entity/custom/DirtChestBlockEntity.java)
...
<<< @/reference/26.1.2/src/main/java/com/example/docs/block/entity/custom/DirtChestBlockEntity.java#container-still-valid
...
@[code transcludeWith=:::use](@/reference/26.1.2/src/main/java/com/example/docs/block/custom/DirtChestBlock.java)
...
@[code transcludeWith=:::menu](@/reference/26.1.2/src/main/java/com/example/docs/block/entity/custom/DirtChestBlockEntity.java)
...
@[code transcludeWith=:::menu](@/reference/26.1.2/src/main/java/com/example/docs/menu/custom/DirtChestMenu.java)
...
@[code transcludeWith=:::registerMenu](@/reference/26.1.2/src/main/java/com/example/docs/menu/ModMenuType.java)

Тепер ми можемо встановити значення, що повертається `createMenu` в блоці-сутності, щоб використовувати наше меню:

@[code transcludeWith=:::providerImplemented](@/reference/26.1.2/src/main/java/com/example/docs/block/entity/custom/DirtChestBlockEntity.java)
...
@[code transcludeWith=:::screen](@/reference/26.1.2/src/client/java/com/example/docs/rendering/screens/inventory/DirtChestScreen.java)
...
@[code transcludeWith=:::registerScreens](@/reference/26.1.2/src/client/java/com/example/docs/ExampleModScreens.java)
