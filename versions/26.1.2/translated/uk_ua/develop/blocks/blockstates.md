...
authors:
  - IMB11
resources:
  https://minecraft.wiki/w/Tutorial:Models#Block_states: Стани блоків — Вікі Minecraft
  https://docs.neoforged.net/docs/blocks/states/: Стани блоків — Документація NeoForge
---
...
@[code transcludeWith=:::3](@/reference/26.1.2/src/main/java/com/example/docs/block/ModBlocks.java)
...
@[code](@/reference/26.1.2/src/main/generated/assets/example-mod/models/block/condensed_oak_log_horizontal.json)
...
Щоб детальніше ознайомитися з усіма модифікаторами, доступними у файлах стану блока, перегляньте сторінку [Вікі Minecraft — Моделі (Стани блоків)](https://minecraft.wiki/w/Tutorial:Models#Block_states).
...
- `axis=z` — коли блок розміщується вздовж осі Z, ми повертаємо модель у позитивний Z.

@[code](@/reference/26.1.2/src/main/generated/assets/example-mod/blockstates/condensed_oak_log.json)
...
@[code transcludeWith=:::1](@/reference/26.1.2/src/main/java/com/example/docs/block/custom/PrismarineLampBlock.java)
...
@[code transcludeWith=:::2](@/reference/26.1.2/src/main/java/com/example/docs/block/custom/PrismarineLampBlock.java)

Ви також повинні встановити усталений стан для властивості `activated` у конструкторі вашого спеціального блока.

@[code transcludeWith=:::3](@/reference/26.1.2/src/main/java/com/example/docs/block/custom/PrismarineLampBlock.java)
...
@[code transcludeWith=:::4](@/reference/26.1.2/src/main/java/com/example/docs/block/custom/PrismarineLampBlock.java)
...
@[code](@/reference/26.1.2/src/main/generated/assets/example-mod/blockstates/prismarine_lamp.json)
...
@[code transcludeWith=:::5](@/reference/26.1.2/src/main/java/com/example/docs/block/custom/PrismarineLampBlock.java)

@[code transcludeWith=:::4](@/reference/26.1.2/src/main/java/com/example/docs/block/ModBlocks.java)
