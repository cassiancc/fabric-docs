...
## Додання компонента їжі {#adding-the-food-component}
...
| Метод                | Опис                                                                            |
| -------------------- | ------------------------------------------------------------------------------- |
| `nutrition`          | Установлює кількість очок голоду, які ваш предмет відновить.    |
| `saturationModifier` | Установлює кількість очок насичення, які ваш предмет відновить. |
