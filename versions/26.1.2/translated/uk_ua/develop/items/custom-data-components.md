...
authors:
  ...
  - ekulxam
resources:
  https://minecraft.wiki/w/Data_component_format#List_of_components: Список стандартних компонентів — Вікі Minecraft
---
...
![Спливна підказка, у якій показано «Used 5 times»](/assets/develop/items/custom_component_1.png)
...
![Спливна підказка показує «Used 0 times»](/assets/develop/items/custom_component_2.png)
...
## Оновлення значення компонента {#setting-component-value}
