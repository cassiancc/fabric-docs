...
@[code transcludeWith=:::1](@/reference/26.1.2/src/main/java/com/example/docs/item/ModItems.java)

Зверніть увагу, як ми використовуємо `T`, [загальний тип](https://docs.oracle.com/javase/tutorial/java/generics/types.html), який розширює `Item`. Це дозволяє нам використовувати той самий метод `register` для реєстрації будь-якого типу предмета, який розширює `Item`. Ми також використовуємо [`функцію`](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/function/Function.html) для фабрики, яка дозволяє нам вказати, як ми хочемо створити наш предмет відповідно до властивостей предмета.
...
@[code transcludeWith=:::2](@/reference/26.1.2/src/main/java/com/example/docs/item/ModItems.java)
...
@[code transcludeWith=:::3](@/reference/26.1.2/src/main/java/com/example/docs/item/ModItems.java)

@[code transcludeWith=:::1](@/reference/26.1.2/src/main/java/com/example/docs/item/ExampleModItems.java)
...
Якщо ви хочете додати предмет до вкладки творчості, перегляньте сторінку [власних вкладок творчості](./custom-creative-tabs) для отримання подробиць.

:::

Для прикладу ми додамо цей предмет до інгредієнтів `CreativeModeTab`, вам потрібно буде використовувати події вкладки творчості Fabric API, зокрема `CreativeModeTabEvents.modifyOutputEvent`

Це можна зробити за допомогою методу `initialize` вашого класу предметів.

@[code transcludeWith=:::4](@/reference/26.1.2/src/main/java/com/example/docs/item/ModItems.java)
...
@[code](@/reference/26.1.2/src/main/generated/assets/example-mod/models/item/suspicious_substance.json)
...
@[code](@/reference/26.1.2/src/main/generated/assets/example-mod/items/suspicious_substance.json)
...
@[code transcludeWith=:::\_10](@/reference/26.1.2/src/main/java/com/example/docs/item/ModItems.java)

Крім того, якщо ви хочете зробити свій предмет паливом, ви можете використати подію `FuelValueEvents.BUILD`:

@[code transcludeWith=:::\_11](@/reference/26.1.2/src/main/java/com/example/docs/item/ModItems.java)
...
Якщо ви хочете, щоб ваш предмет мав спеціальну підказку, вам потрібно буде створити клас, який розширює `Item` і замінює метод `appendHoverText`. Зауважте, що цей метод застарів, оскільки Mojang працює над тим, щоб поведінка предметів оброблялася виключно через компоненти, а не через предмети — для подробиць див. [власні компоненти даних](./custom-data-components).
...
@[code lang=java transcludeWith=:::3](@/reference/26.1.2/src/main/java/com/example/docs/item/custom/LightningStick.java)
