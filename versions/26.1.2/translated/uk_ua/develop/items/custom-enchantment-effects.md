...
description: Дізнайтеся, як створити власні ефекти зачарування.
authors:
  - CelDaemon
  - krizh-p
resources:
  https://minecraft.wiki/w/Enchantment_definition: Визначення зачарувань — Вікі Minecraft
  https://misode.github.io/enchantment/: Генератор зачарувань Misode
---
...
Щоб швидко створити власні зачарування, ви можете скористатися [генератором Misode](https://misode.github.io/enchantment/).
