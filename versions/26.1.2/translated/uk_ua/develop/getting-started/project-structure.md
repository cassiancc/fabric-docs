...
Файл [`fabric.mod.json`](../loader/fabric-mod-json) — це основний файл, який описує ваш мод Завантажувача Fabric. Він містить таку інформацію, як ID мода, версія та залежності.
...
Як згадувалося раніше, файл [`fabric.mod.json`](../loader/fabric-mod-json) містить поле під назвою `entrypoints` — це поле використовується для визначення точок входу, які надає ваш мод.
