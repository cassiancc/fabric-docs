...
Оскільки ми хочемо використовувати текстури дубової колоди, але маємо `BOTTOM`, `TOP` і `SIDE` `TextureSlot`, нам потрібно створити новий.
...
### Власний метод генерації даних {#custom-datagen-method}
