...
- [Доповнення вмісту](#contributing-content)
- [Доповнення фреймворку](#contributing-framework)
...
## <Badge type="tip">new-content</Badge> Доповнення вмісту {#contributing-content}
...
4. Відкрийте запит на зміни в початковому репозиторії
...
Якщо ви хочете переглянути свої зміни локально, вам потрібно буде встановити [Node.js 18+](https://nodejs.org/uk/) та [pnpm](https://pnpm.io/uk/).
...
- Увесь уміст правильний?
- Увесь уміст актуальний?
...
## <Badge type="tip">framework</Badge> — Доповнення фреймворку {#contributing-framework}
...
### Розмістіть код у прикладі мода {#place-code-within-the-example-mod}

Якщо ви створюєте або змінюєте сторінки, що містять код, розмістіть код у відповідному місці в прикладі мода (розташованого в теці `/reference` сховища). Потім скористайтеся [функцією фрагмента коду, запропонованою VitePress](https://vitepress.dev/guide/markdown#import-code-snippets), щоб вставити код.

Наприклад, щоб виділити рядки 15-21 файлу `ExampleMod.java` з мода:
