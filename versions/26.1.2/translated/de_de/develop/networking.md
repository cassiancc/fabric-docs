...
@[code lang=java transcludeWith=:::summon_Lightning_payload](@/reference/26.1.2/src/main/java/com/example/docs/networking/basic/ClientboundSummonLightningPayload.java)
...
@[code lang=java transclude={13-13}](@/reference/26.1.2/src/main/java/com/example/docs/networking/basic/ClientboundSummonLightningPayload.java)

- Eine öffentliche, statische Instanz von `CustomPayload.Type` zur eindeutigen Identifizierung dieses benutzdefinierten Payloads. Wir werden auf diese ID sowohl in unserem allgemeinen als auch in unserem Client-Code verweisen.

@[code lang=java transclude={14-14}](@/reference/26.1.2/src/main/java/com/example/docs/networking/basic/ClientboundSummonLightningPayload.java)
...
@[code lang=java transclude={15-15}](@/reference/26.1.2/src/main/java/com/example/docs/networking/basic/ClientboundSummonLightningPayload.java)

Wir haben auch `type` überschrieben, um unsere Payload-ID zurückzugeben.

@[code lang=java transclude={17-20}](@/reference/26.1.2/src/main/java/com/example/docs/networking/basic/ClientboundSummonLightningPayload.java)
...
@[code lang=java transclude={14-14}](@/reference/26.1.2/src/main/java/com/example/docs/networking/basic/ExampleModNetworkingBasic.java)
...
@[code lang=java transcludeWith=:::lightning_tater_item](@/reference/26.1.2/src/main/java/com/example/docs/networking/basic/LightningTaterItem.java)
...
@[code lang=java transclude={22-24}](@/reference/26.1.2/src/main/java/com/example/docs/networking/basic/LightningTaterItem.java)

Wir erstellen eine Instanz des Payloads mit der Position des Users:

@[code lang=java transclude={26-26}](@/reference/26.1.2/src/main/java/com/example/docs/networking/basic/LightningTaterItem.java)

Schließlich rufen wir die Spieler in dem Serverlevel durch `PlayerLookup` ab und senden ein Paket an jeden Spieler.

@[code lang=java transclude={28-30}](@/reference/26.1.2/src/main/java/com/example/docs/networking/basic/LightningTaterItem.java)
...
Dies kann im **Client-Initialisierer** erfolgen, indem `ClientPlayNetworking.registerGlobalReceiver` aufgerufen und ein
`CustomPayload.Type` und ein `PlayPayloadHandler` übergeben wird, der ein funktionales Interface ist.
...
@[code lang=java transcludeWith=:::client_global_receiver](@/reference/26.1.2/src/client/java/com/example/docs/network/basic/ExampleModNetworkingBasicClient.java)
...
@[code lang=java transclude={32-32}](@/reference/26.1.2/src/client/java/com/example/docs/network/basic/ExampleModNetworkingBasicClient.java)

Schließlich erstellen wir eine `LightningBolt` und fügen diesen dem Level hinzu.

@[code lang=java transclude={33-38}](@/reference/26.1.2/src/client/java/com/example/docs/network/basic/ExampleModNetworkingBasicClient.java)
...
@[code lang=java transcludeWith=:::give_glowing_effect_payload](@/reference/26.1.2/src/main/java/com/example/docs/networking/basic/GiveGlowingEffectServerboundPayload.java)
...
Dann registrieren wir unseren Payload in unserem **gemeinsamen Initialisierer**. Diesmal jedoch als _Client-to-Server_ Payload unter Verwendung von `PayloadTypeRegistry.serverboundPlay().register`.

@[code lang=java transclude={15-15}](@/reference/26.1.2/src/main/java/com/example/docs/networking/basic/ExampleModNetworkingBasic.java)
...
@[code lang=java transcludeWith=:::use_entity_callback](@/reference/26.1.2/src/client/java/com/example/docs/network/basic/ExampleModNetworkingBasicClient.java)
...
@[code lang=java transclude={51-51}](@/reference/26.1.2/src/client/java/com/example/docs/network/basic/ExampleModNetworkingBasicClient.java)

Schließlich senden wir ein Paket an den Server, indem wir `ClientPlayNetworking.send` mit der Instanz unseres
`GiveGlowingEffectServerboundPayload` aufrufen.

@[code lang=java transclude={52-52}](@/reference/26.1.2/src/client/java/com/example/docs/network/basic/ExampleModNetworkingBasicClient.java)
...
@[code lang=java transcludeWith=:::server_global_receiver](@/reference/26.1.2/src/main/java/com/example/docs/networking/basic/ExampleModNetworkingBasic.java)
...
@[code lang=java transclude={19-19}](@/reference/26.1.2/src/main/java/com/example/docs/networking/basic/ExampleModNetworkingBasic.java)
...
@[code lang=java transclude={22-22}](@/reference/26.1.2/src/main/java/com/example/docs/networking/basic/ExampleModNetworkingBasic.java)
