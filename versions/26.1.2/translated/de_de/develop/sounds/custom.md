...
@[code lang=json](@/reference/26.1.2/src/main/resources/assets/example-mod/sounds.json)
...
@[code lang=java transcludeWith=:::1](@/reference/26.1.2/src/main/java/com/example/docs/sound/CustomSounds.java)
...
@[code lang=java transcludeWith=:::2](@/reference/26.1.2/src/main/java/com/example/docs/sound/ExampleModSounds.java)

## Das benutzerdefinierte SoundEvent nutzen {#using-the-custom-soundevent}

Verwende die Hilfsklasse, um auf das benutzerdefinierte SoundEvent zuzugreifen. Auf der Seite [Sounds abspielen](./using-sounds) erfährst du, wie man Sounds abspielt.
