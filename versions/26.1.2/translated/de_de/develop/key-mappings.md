...
@[code lang=java transcludeWith=:::category](@/reference/26.1.2/src/client/java/com/example/docs/keymapping/ExampleModKeyMappingsClient.java)
...
@[code lang=java transcludeWith=:::key_mapping](@/reference/26.1.2/src/client/java/com/example/docs/keymapping/ExampleModKeyMappingsClient.java)
...
@[code lang=java transcludeWith=:::client_tick_event](@/reference/26.1.2/src/client/java/com/example/docs/keymapping/ExampleModKeyMappingsClient.java)
