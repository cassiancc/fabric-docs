...
@[code lang=java transcludeWith=:::custom-pipelines:define-pipeline](@/reference/26.1.2/src/client/java/com/example/docs/rendering/CustomRenderPipeline.java)
...
@[code lang=java transcludeWith=:::custom-pipelines:extraction-phase](@/reference/26.1.2/src/client/java/com/example/docs/rendering/CustomRenderPipeline.java)
...
@[code lang=java transcludeWith=:::custom-pipelines:drawing-phase](@/reference/26.1.2/src/client/java/com/example/docs/rendering/CustomRenderPipeline.java)
...
@[code lang=java transcludeWith=:::custom-pipelines:clean-up](@/reference/26.1.2/src/client/java/com/example/docs/rendering/CustomRenderPipeline.java)

@[code lang=java](@/reference/26.1.2/src/client/java/com/example/docs/mixin/client/GameRendererMixin.java)
...
@[code lang=java](@/reference/26.1.2/src/client/java/com/example/docs/rendering/CustomRenderPipeline.java)
