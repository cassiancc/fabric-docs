...
如果想要将物品添加到自定义的创造模式物品栏，请参阅[自定义创造模式标签页](./custom-creative-tabs)页面以了解更多。

:::

这里为举例，我们将这个物品添加到原材料的 `CreativeModeTab` 中，你需要使用 Fabric API 的创造模式标签页事件——也就是 `CreativeModeTabEvents.modifyOutputEvent`
