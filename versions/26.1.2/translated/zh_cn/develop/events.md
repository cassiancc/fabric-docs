...
@[code lang=java transcludeWith=:::1](@/reference/26.1.2/src/main/java/com/example/docs/event/ExampleModEvents.java)
...
@[code lang=java transclude={38-40}](@/reference/26.1.2/src/main/java/com/example/docs/event/ExampleModEvents.java)
...
@[code highlight={6-7} transcludeWith=:::2](@/reference/26.1.2/src/main/java/com/example/docs/event/ExampleModEvents.java)
...
@[code lang=java transcludeWith=:::](@/reference/26.1.2/src/main/java/com/example/docs/event/SheepShearCallback.java)

让我们更深入地看看。 当 invoker 被调用时，我们将遍历所有监听器：

@[code lang=java transclude={21-22}](@/reference/26.1.2/src/main/java/com/example/docs/event/SheepShearCallback.java)

然后在监听器上调用我们的方法（在本例中为 `interact`）来获取响应：

@[code lang=java transclude={33-33}](@/reference/26.1.2/src/main/java/com/example/docs/event/SheepShearCallback.java)
...
@[code lang=java transclude={25-30}](@/reference/26.1.2/src/main/java/com/example/docs/event/SheepShearCallback.java)

我们可以在回调类的顶部添加 Javadoc 注释注明每一种 `ActionResult` 的作用。 在本例中，它应该是这样的：

@[code lang=java transclude={9-16}](@/reference/26.1.2/src/main/java/com/example/docs/event/SheepShearCallback.java)
...
@[code lang=java transcludeWith=:::](@/reference/26.1.2/src/main/java/com/example/docs/mixin/event/SheepEntityMixin.java)
...
@[code lang=java transcludeWith=:::3](@/reference/26.1.2/src/main/java/com/example/docs/event/ExampleModEvents.java)
