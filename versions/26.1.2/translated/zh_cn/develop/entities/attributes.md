...
@[code lang=java transcludeWith=:::register](@/reference/26.1.2/src/main/java/com/example/docs/entity/attribute/ModAttributes.java)

我们注册一个叫做 `AGGRO_RANGE` 的属性，名称为 `aggro_range`，默认值 `8.0`，最小值 `0`，最大值设置为能多高就多高。 属性不会向玩家同步。

@[code lang=java transcludeWith=:::attributes](@/reference/26.1.2/src/main/java/com/example/docs/entity/attribute/ModAttributes.java)
...
@[code lang=java transcludeWith=:::initialize](@/reference/26.1.2/src/main/java/com/example/docs/entity/attribute/ModAttributes.java)

@[code lang=java transcludeWith=:::init](@/reference/26.1.2/src/main/java/com/example/docs/entity/attribute/ExampleModAttributes.java)
