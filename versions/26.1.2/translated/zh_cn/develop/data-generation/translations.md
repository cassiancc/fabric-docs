...
@[code lang=java transcludeWith=:::datagen-translations:provider](@/reference/26.1.2/src/client/java/com/example/docs/datagen/ExampleModEnglishLangProvider.java)
...
@[code lang=java transcludeWith=:::datagen-translations:register](@/reference/26.1.2/src/client/java/com/example/docs/datagen/ExampleModDataGenerator.java)
...
@[code lang=java transcludeWith=:::datagen-translations:build](@/reference/26.1.2/src/client/java/com/example/docs/datagen/ExampleModEnglishLangProvider.java)
