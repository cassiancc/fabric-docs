...
@[code transcludeWith=:::recipeInput](@/reference/26.1.2/src/main/java/com/example/docs/recipe/UpgradingRecipeInput.java)
...
@[code transcludeWith=:::baseClass](@/reference/26.1.2/src/main/java/com/example/docs/recipe/UpgradingRecipe.java)
...
@[code transcludeWith=:::implementing](@/reference/26.1.2/src/main/java/com/example/docs/recipe/UpgradingRecipe.java)
...
@[code transcludeWith=:::mapCodec](@/reference/26.1.2/src/main/java/com/example/docs/recipe/UpgradingRecipe.java)

可以使用 `StreamCodec#composite` 以类似的方式创建流编解码器：

@[code transcludeWith=:::streamCodec](@/reference/26.1.2/src/main/java/com/example/docs/recipe/UpgradingRecipe.java)

现在我们将注册配方序列化器以及配方类型。 你可以在模组的初始化器中完成此操作，也可以在一个单独的类中完成，并通过模组初始化器调用该方法：

@[code transcludeWith=:::registration](@/reference/26.1.2/src/main/java/com/example/docs/recipe/ExampleModRecipes.java)

回到我们的配方类，现在我们可以添加返回我们刚刚注册的对象的方法了：

@[code transcludeWith=:::implementRegistryObjects](@/reference/26.1.2/src/main/java/com/example/docs/recipe/UpgradingRecipe.java)
...
@[code transcludeWith=:::recipeBook](@/reference/26.1.2/src/main/java/com/example/docs/recipe/UpgradingRecipe.java)
...
@[code](@/reference/26.1.2/src/main/resources/data/example-mod/recipe/upgrading/diamond_pickaxe.json)
...
@[code transcludeWith=:::menu](@/reference/26.1.2/src/main/java/com/example/docs/menu/custom/UpgradingMenu.java)
...
@[code transcludeWith=:::recipeSync](@/reference/26.1.2/src/main/java/com/example/docs/recipe/ExampleModRecipes.java)

同步完成后，可以随时从客户端的配方管理器中检索配方：

@[code transcludeWith=:::recipeSyncClient](@/reference/26.1.2/src/client/java/com/example/docs/ExampleModRecipesClient.java)
