...
Если вы хотите предварительно локально просматривать свои изменения, вам нужно будет установить [Node.js версии 18 или выше](https://nodejs.org/en/) и [pnpm](https://pnpm.io/).
...
### Пишите оригинал на американском английском {#write-the-original-in-american-english}

Вся оригинальная документация написана на английском языке в соответствии с американскими правилами грамматики.

### Добавляйте данные в начало файла {#add-data-to-the-frontmatter}
...
### Добавляйте "якоря" к заголовкам {#add-anchors-to-headings}
...
### Размещайте код внутри Example мода {#place-code-within-the-example-mod}

Если вы создаете или изменяете страницы, содержащие код, размещайте этот код в соответствующем месте внутри Example мода (он находится в папке /reference репозитория). Затем используйте функцию [импорта фрагментов/кусков кода, которую предоставляет VitePress](https://vitepress.dev/guide/markdown#import-code-snippets), чтобы встроить этот код на страницу.
...
```md
<<< @/reference/26.1.2/src/main/java/com/example/docs/ExampleMod.java{15-21}
```

<<< @/reference/26.1.2/src/main/java/com/example/docs/ExampleMod.java{15-21}[java]
...
```md
@[code transcludeWith=#entrypoint](@/reference/26.1.2/src/main/java/com/example/docs/ExampleMod.java)
```
...
Если вам нужна помощь с этим, спросите [в дискорде Fabric](https://discord.fabricmc.net/) в канале `#docs`.

### Добавьте новые страницы в соответствующие боковые панели {#add-new-pages-to-the-relevant-sidebars}
...
### Используйте относительные ссылки! {#use-relative-links}
