...
Для доступа к полям или методам зачастую безопаснее и проще использовать [accessor mixins](https://wiki.fabricmc.net/tutorial:mixin_accessors),
...
@[code lang=classtweaker:no-line-numbers transcludeWith=:::accesswidening-examples:classes:::](@/reference/26.1.2/src/main/resources/example-mod.classtweaker)
...
@[code lang=classtweaker:no-line-numbers transcludeWith=:::accesswidening-examples:methods:::](@/reference/26.1.2/src/main/resources/example-mod.classtweaker)
...
@[code lang=classtweaker:no-line-numbers transcludeWith=:::accesswidening-examples:fields:::](@/reference/26.1.2/src/main/resources/example-mod.classtweaker)
