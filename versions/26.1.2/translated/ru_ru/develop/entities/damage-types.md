...
authors:
  ...
  - mattidragon
resources:
  https://minecraft.wiki/w/Damage_type: Тип урона - Minecraft Wiki
  https://docs.neoforged.net/docs/resources/server/damagetypes/: Типы урона и источники урона - Докумкентация NeoForge (кроме datagen)
---
...
@[code lang=json](@/reference/26.1.2/src/main/generated/data/example-mod/damage_type/tater.json)
...
@[code lang=java transcludeWith=:::1](@/reference/26.1.2/src/main/java/com/example/docs/damage/ExampleModDamageTypes.java)
...
@[code lang=java transclude={22-26}](@/reference/26.1.2/src/main/java/com/example/docs/damage/TaterBlock.java)

Затем мы вызываем `entity.damage()` с нашим `DamageSource` и суммой.

@[code lang=java transclude={27-27}](@/reference/26.1.2/src/main/java/com/example/docs/damage/TaterBlock.java)

Полная реализация блока:

@[code lang=java transcludeWith=:::1](@/reference/26.1.2/src/main/java/com/example/docs/damage/TaterBlock.java)
...
Некоторые виды урона могут игнорировать броню, эффекты мобов и т. п. Теги используются для управления этими свойствами
типов урона.
...
@[code lang=json](@/reference/26.1.2/src/main/generated/data/minecraft/tags/damage_type/bypasses_armor.json)
