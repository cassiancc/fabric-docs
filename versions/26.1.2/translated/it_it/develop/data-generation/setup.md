...
@[code lang=java transcludeWith=:::datagen-setup:generator](@/reference/26.1.2/src/client/java/com/example/docs/datagen/ExampleModDataGenerator.java)
...
@[code lang=java transcludeWith=:::datagen-setup:pack](@/reference/26.1.2/src/client/java/com/example/docs/datagen/ExampleModDataGenerator.java)
...
- [Modelli dei Blocchi](./block-models)
- [Modelli degli Oggetti](./item-models)
