...
@[code transcludeWith=:::5](@/reference/26.1.2/src/main/java/com/example/docs/item/ModItems.java)

Come nell'esempio della pagina [Creare il Tuo Primo Oggetto](./first-item), useremo la componente sopra:

@[code transcludeWith=:::poisonous_apple](@/reference/26.1.2/src/main/java/com/example/docs/item/ModItems.java)
