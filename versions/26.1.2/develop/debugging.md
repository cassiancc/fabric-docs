...
@[code lang=java transcludeWith=:::problems:basic-logger-definition](@/reference/26.1.2/src/main/java/com/example/docs/debug/ExampleModDebug.java)
...
@[code lang=java transcludeWith=:::problems:using-logger](@/reference/26.1.2/src/main/java/com/example/docs/debug/TestItem.java)
...
@[code lang=java transcludeWith=:::problems:log-levels](@/reference/26.1.2/src/main/java/com/example/docs/debug/ExampleModDebug.java)
...
@[code lang=java transcludeWith=:::problems:logger-usage-example](@/reference/26.1.2/src/main/java/com/example/docs/debug/TestItem.java)
...
@[code lang=xml](@/reference/26.1.2/log4j-dev.xml)

Then in the `build.gradle`, tell Loom to use our new configuration.

@[code lang=java transcludeWith=:::debug-logging](@/reference/26.1.2/build.gradle)

Now, when we send debug log messages, we'll be able to see them in the console.

@[code lang=java transcludeWith=:::problems:debug-logging](@/reference/26.1.2/src/main/java/com/example/docs/debug/ExampleModDebug.java)
...
@[code lang=java transcludeWith=:::problems:breakpoints](@/reference/26.1.2/src/main/java/com/example/docs/debug/TestItem.java)
