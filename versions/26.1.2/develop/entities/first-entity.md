...
@[code transcludeWith=:::registerclass](@/reference/26.1.2/src/main/java/com/example/docs/entity/MiniGolemEntity.java)
...
@[code transcludeWith=:::types](@/reference/26.1.2/src/main/java/com/example/docs/entity/ModEntityTypes.java)
...
@[code transcludeWith=:::goals](@/reference/26.1.2/src/main/java/com/example/docs/entity/MiniGolemEntity.java)
...
@[code transcludeWith=:::entitystate](@/reference/26.1.2/src/client/java/com/example/docs/entity/state/MiniGolemEntityRenderState.java)
...
@[code transcludeWith=:::model1](@/reference/26.1.2/src/client/java/com/example/docs/entity/model/MiniGolemEntityModel.java)
...
@[code transcludeWith=:::model_texture_data](@/reference/26.1.2/src/client/java/com/example/docs/entity/model/MiniGolemEntityModel.java)
...
@[code transcludeWith=:::model_layer](@/reference/26.1.2/src/client/java/com/example/docs/entity/model/ModEntityModelLayers.java)

This class must then be initialized in the mod's client initializer.

@[code transcludeWith=::register_client](@/reference/26.1.2/src/client/java/com/example/docs/entity/ExampleModCustomEntityClient.java)
...
@[code transcludeWith=:::renderer](@/reference/26.1.2/src/client/java/com/example/docs/entity/renderer/MiniGolemEntityRenderer.java)
...
@[code transcludeWith=::register_renderer](@/reference/26.1.2/src/client/java/com/example/docs/entity/ExampleModCustomEntityClient.java)
...
@[code transcludeWith=:::model_animation](@/reference/26.1.2/src/client/java/com/example/docs/entity/model/MiniGolemEntityModel.java)
...
@[code transcludeWith=:::datatracker](@/reference/26.1.2/src/main/java/com/example/docs/entity/MiniGolemEntity.java)
...
@[code transcludeWith=:::savedata](@/reference/26.1.2/src/main/java/com/example/docs/entity/MiniGolemEntity.java)
...
@[code transcludeWith=:::dancing_animation](@/reference/26.1.2/src/main/java/com/example/docs/entity/MiniGolemEntity.java)
...
@[code transcludeWith=:::dancing_animation](@/reference/26.1.2/src/client/java/com/example/docs/entity/animation/MiniGolemAnimations.java)
...
@[code transcludeWith=:::dancing_animation](@/reference/26.1.2/src/client/java/com/example/docs/entity/model/MiniGolemEntityModel.java)
