...
@[code lang=java transcludeWith=#particle_register_main](@/reference/26.1.2/src/main/java/com/example/docs/ExampleMod.java)
...
@[code lang=java transcludeWith=#particle_register_client](@/reference/26.1.2/src/client/java/com/example/docs/ExampleModClient.java)
...
You can see all the particle factories by looking at all the implementations of the `ParticleProvider` interface. This is helpful if you want to use another particle's behavior for your own particle.
...
@[code lang=json](@/reference/26.1.2/src/main/resources/assets/example-mod/particles/sparkle_particle.json)
