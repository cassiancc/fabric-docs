...
This page refers to normal screens, not menus - these screens are the ones that are opened by the player on the client, not the ones that are handled by the server.
...
@[code lang=java transcludeWith=:::1](@/reference/26.1.2/src/client/java/com/example/docs/rendering/screens/CustomScreen.java)
...
@[code lang=java transcludeWith=:::2](@/reference/26.1.2/src/client/java/com/example/docs/rendering/screens/CustomScreen.java)
