...
@[code lang=java transcludeWith=:::registration](@/reference/26.1.2/src/client/java/com/example/docs/rendering/RenderingConceptsEntrypoint.java)

**Implementation of `hudLayer()`:**

@[code lang=java transcludeWith=:::hudLayer](@/reference/26.1.2/src/client/java/com/example/docs/rendering/RenderingConceptsEntrypoint.java)
...
@[code lang=java transcludeWith=:::2](@/reference/26.1.2/src/client/java/com/example/docs/rendering/RenderingConceptsEntrypoint.java)
...
@[code lang=java transcludeWith=:::3](@/reference/26.1.2/src/client/java/com/example/docs/rendering/RenderingConceptsEntrypoint.java)
