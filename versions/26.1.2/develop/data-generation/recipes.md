...
@[code lang=java transcludeWith=:::datagen-recipes:provider](@/reference/26.1.2/src/client/java/com/example/docs/datagen/ExampleModRecipeProvider.java)

To finish setup, add this provider to your `DataGeneratorEntrypoint` within the `onInitializeDataGenerator` method.

@[code lang=java transcludeWith=:::datagen-recipes:register](@/reference/26.1.2/src/client/java/com/example/docs/datagen/ExampleModDataGenerator.java)
...
@[code lang=java transcludeWith=:::datagen-recipes:shapeless](@/reference/26.1.2/src/client/java/com/example/docs/datagen/ExampleModRecipeProvider.java)

### Dye Recipes {#dye-recipes}

Dye recipes are used to dye items in your inventory.

<<< @/reference/26.1.2/src/client/java/com/example/docs/datagen/ExampleModRecipeProvider.java#datagen-recipes--dye
...
@[code lang=java transcludeWith=:::datagen-recipes:shaped](@/reference/26.1.2/src/client/java/com/example/docs/datagen/ExampleModRecipeProvider.java)
...
<<< @/reference/26.1.2/src/client/java/com/example/docs/datagen/ExampleModRecipeProvider.java#datagen-recipes--smelting

Smoking is a little different, it does not use the same recipe generator as smelter-like blocks do.

<<< @/reference/26.1.2/src/client/java/com/example/docs/datagen/ExampleModRecipeProvider.java#datagen-recipes--smoking
...
<<< @/reference/26.1.2/src/client/java/com/example/docs/datagen/ExampleModRecipeProvider.java#datagen-recipes--conditions
