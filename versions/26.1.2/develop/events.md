...
<<< @/reference/26.1.2/src/main/java/com/example/docs/event/ExampleModEvents.java#attack-block-callback-event
...
<<< @/reference/26.1.2/src/main/java/com/example/docs/event/ExampleModEvents.java#loot-table-events
...
<<< @/reference/26.1.2/src/main/java/com/example/docs/event/ExampleModEvents.java#loot-pool-builder{5-7}
...
<<< @/reference/26.1.2/src/main/java/com/example/docs/event/SheepShearCallback.java#sheep-shear-callback

Let's look at this more in-depth. When the invoker is called, we iterate over all listeners:

<<< @/reference/26.1.2/src/main/java/com/example/docs/event/SheepShearCallback.java#listener-iterator
...
<<< @/reference/26.1.2/src/main/java/com/example/docs/event/SheepShearCallback.java#interact-method
...
<<< @/reference/26.1.2/src/main/java/com/example/docs/event/SheepShearCallback.java#return-value
...
<<< @/reference/26.1.2/src/main/java/com/example/docs/event/SheepShearCallback.java#javadoc-comment
...
<<< @/reference/26.1.2/src/main/java/com/example/docs/mixin/event/SheepMixin.java#sheep-mixin
...
<<< @/reference/26.1.2/src/main/java/com/example/docs/event/ExampleModEvents.java#sheep-shear-callback-event
