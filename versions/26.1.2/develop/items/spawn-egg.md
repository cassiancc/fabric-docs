...
@[code transcludeWith=:::custom_entity_spawn_egg](@/reference/26.1.2/src/main/java/com/example/docs/item/ModItems.java)
...
@[code](@/reference/26.1.2/src/main/generated/assets/example-mod/models/item/mini_golem_spawn_egg.json)
...
@[code](@/reference/26.1.2/src/main/generated/assets/example-mod/items/mini_golem_spawn_egg.json)
...
@[code transcludeWith=:::spawn_egg_creative_tab](@/reference/26.1.2/src/main/java/com/example/docs/item/ModItems.java)
