...
@[code transcludeWith=#entrypoint](@/reference/26.1.2/src/main/java/com/example/docs/enchantment/effect/LightningEnchantmentEffect.java)
...
@[code transcludeWith=#entrypoint](@/reference/26.1.2/src/main/java/com/example/docs/enchantment/ModEnchantmentEffects.java)
...
@[code](@/reference/26.1.2/src/main/generated/data/example-mod/enchantment/thundering.json)
