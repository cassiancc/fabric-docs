...
@[code lang=java transclude={18-27}](@/reference/26.1.2/src/main/java/com/example/docs/potion/ExampleModPotions.java)
...
@[code lang=java transclude={29-40}](@/reference/26.1.2/src/main/java/com/example/docs/potion/ExampleModPotions.java)
