...
@[code lang=java transcludeWith=:::waxcap-tinting](@/reference/26.1.2/src/main/java/com/example/docs/block/ModBlocks.java)
...
@[code lang=java transcludeWith=:::color_provider](@/reference/26.1.2/src/client/java/com/example/docs/appearance/ExampleModAppearanceClient.java)
