...
<<< @/reference/26.2/src/main/resources/assets/example-mod/sounds.json
...
<<< @/reference/26.2/src/main/java/com/example/docs/sound/CustomSounds.java#custom_sounds

This way, the mod's initializer only needs to implement one line to register all custom SoundEvents.

<<< @/reference/26.2/src/main/java/com/example/docs/sound/ExampleModSounds.java#example_mod_sounds
