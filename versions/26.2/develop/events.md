...
<<< @/reference/26.2/src/main/java/com/example/docs/event/ExampleModEvents.java#attack_block_callback_event
...
<<< @/reference/26.2/src/main/java/com/example/docs/event/ExampleModEvents.java#loot_table_events
...
<<< @/reference/26.2/src/main/java/com/example/docs/event/ExampleModEvents.java#loot_pool_builder{5-7}
...
<<< @/reference/26.2/src/main/java/com/example/docs/event/SheepShearCallback.java#sheep_shear_callback

Let's look at this more in-depth. When the invoker is called, we iterate over all listeners:

<<< @/reference/26.2/src/main/java/com/example/docs/event/SheepShearCallback.java#listener_iterator
...
<<< @/reference/26.2/src/main/java/com/example/docs/event/SheepShearCallback.java#interact_method
...
<<< @/reference/26.2/src/main/java/com/example/docs/event/SheepShearCallback.java#return_value
...
<<< @/reference/26.2/src/main/java/com/example/docs/event/SheepShearCallback.java#javadoc_comment
...
<<< @/reference/26.2/src/main/java/com/example/docs/mixin/event/SheepMixin.java#sheep_mixin
...
<<< @/reference/26.2/src/main/java/com/example/docs/event/ExampleModEvents.java#sheep_shear_callback_event
