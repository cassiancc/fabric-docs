...
<<< @/reference/26.2/src/main/java/com/example/docs/component/ModComponents.java#mod_components
...
<<< @/reference/26.2/src/main/java/com/example/docs/component/ModComponents.java#integer_component
...
<<< @/reference/26.2/src/main/java/com/example/docs/item/custom/CounterItem.java#item
...
<<< @/reference/26.2/src/main/java/com/example/docs/component/ComponentWithTooltip.java#component_with_tooltip
...
<<< @/reference/26.2/src/main/java/com/example/docs/ExampleMod.java#tooltip_provider
...
<<< @/reference/26.2/src/client/java/com/example/docs/ExampleModClient.java#tooltip_provider_client
...
<<< @/reference/26.2/src/main/java/com/example/docs/item/ModItems.java#counter
...
<<< @/reference/26.2/src/main/java/com/example/docs/item/custom/CounterItem.java#fixed_append_hover_text
...
<<< @/reference/26.2/src/main/java/com/example/docs/item/custom/CounterItem.java#use
...
<<< @/reference/26.2/src/main/java/com/example/docs/component/AdvancedCustomComponent.java#codec
...
<<< @/reference/26.2/src/main/java/com/example/docs/component/ModComponents.java#custom_component
...
<<< @/reference/26.2/src/main/java/com/example/docs/component/AdvancedCustomComponent.java#advanced_custom_component

Then, you can register the `TooltipProvider` via `ItemComponentTooltipProviderRegistry`. This is called in `onInitialize` in the `ModInitializer`.

<<< @/reference/26.2/src/main/java/com/example/docs/ExampleMod.java#advanced_tooltip_provider
