...
<<< @/reference/26.2/src/main/java/com/example/docs/item/ModItemIds.java#mod_item_ids_class
...
<<< @/reference/26.2/src/main/java/com/example/docs/item/ModItems.java#mod_items_class
...
<<< @/reference/26.2/src/main/java/com/example/docs/item/ModItemIds.java#suspicious_substance

<<< @/reference/26.2/src/main/java/com/example/docs/item/ModItems.java#suspicious_substance
...
<<< @/reference/26.2/src/main/java/com/example/docs/item/ModItems.java#initialize

<<< @/reference/26.2/src/main/java/com/example/docs/item/ExampleModItems.java#initialize
...
<<< @/reference/26.2/src/main/java/com/example/docs/item/ModItems.java#add_to_creative_tab
...
<<< @/reference/26.2/src/main/generated/assets/example-mod/models/item/suspicious_substance.json
...
<<< @/reference/26.2/src/main/generated/assets/example-mod/items/suspicious_substance.json
...
<<< @/reference/26.2/src/main/java/com/example/docs/item/ModItems.java#compostable_item

Alternatively, if you want to make your item a fuel, you can use the `FuelValueEvents.BUILD` event:

<<< @/reference/26.2/src/main/java/com/example/docs/item/ModItems.java#fuel_item
...
<<< @/reference/26.2/src/main/java/com/example/docs/item/custom/LightningStick.java#custom_tooltip
