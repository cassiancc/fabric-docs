...
<<< @/reference/26.2/src/main/java/com/example/docs/networking/basic/ClientboundSummonLightningPayload.java#summon_lightning_payload
...
<<< @/reference/26.2/src/main/java/com/example/docs/networking/basic/ClientboundSummonLightningPayload.java#identifier
...
<<< @/reference/26.2/src/main/java/com/example/docs/networking/basic/ClientboundSummonLightningPayload.java#payload_type

- A public static instance of a `StreamCodec` so that the game knows how to serialize/deserialize the contents of the
  packet.

<<< @/reference/26.2/src/main/java/com/example/docs/networking/basic/ClientboundSummonLightningPayload.java#stream_codec

We have also overridden `type` to return our payload ID.

<<< @/reference/26.2/src/main/java/com/example/docs/networking/basic/ClientboundSummonLightningPayload.java#type
...
<<< @/reference/26.2/src/main/java/com/example/docs/networking/basic/ExampleModNetworkingBasic.java#clientbound
...
<<< @/reference/26.2/src/main/java/com/example/docs/networking/basic/LightningTaterItem.java#lightning_tater_item

Let's examine the code above.

We only send packets when the action is initiated on the server, by returning early with a `isClientSide()` check:

<<< @/reference/26.2/src/main/java/com/example/docs/networking/basic/LightningTaterItem.java#client_check

We create an instance of the payload with the user's position:

<<< @/reference/26.2/src/main/java/com/example/docs/networking/basic/LightningTaterItem.java#payload_instance

Finally, we get the players in the server level through `PlayerLookup` and send a packet to each player.

<<< @/reference/26.2/src/main/java/com/example/docs/networking/basic/LightningTaterItem.java#lookup
...
<<< @/reference/26.2/src/client/java/com/example/docs/network/basic/ExampleModNetworkingBasicClient.java#client_global_receiver
...
<<< @/reference/26.2/src/client/java/com/example/docs/network/basic/ExampleModNetworkingBasicClient.java#payload_pos

Finally, we create a `LightningBolt` and add it to the level.

<<< @/reference/26.2/src/client/java/com/example/docs/network/basic/ExampleModNetworkingBasicClient.java#lightning_bolt
...
<<< @/reference/26.2/src/main/java/com/example/docs/networking/basic/GiveGlowingEffectServerboundPayload.java#give_glowing_effect_payload
...
<<< @/reference/26.2/src/main/java/com/example/docs/networking/basic/ExampleModNetworkingBasic.java#serverbound
...
<<< @/reference/26.2/src/client/java/com/example/docs/network/basic/ExampleModNetworkingBasicClient.java#use_entity_callback
...
<<< @/reference/26.2/src/client/java/com/example/docs/network/basic/ExampleModNetworkingBasicClient.java#payload
...
<<< @/reference/26.2/src/client/java/com/example/docs/network/basic/ExampleModNetworkingBasicClient.java#send
...
<<< @/reference/26.2/src/main/java/com/example/docs/networking/basic/ExampleModNetworkingBasic.java#server_global_receiver
...
<<< @/reference/26.2/src/main/java/com/example/docs/networking/basic/ExampleModNetworkingBasic.java#validate_entity
...
<<< @/reference/26.2/src/main/java/com/example/docs/networking/basic/ExampleModNetworkingBasic.java#entity_checks
