...
<<< @/reference/26.2/src/main/java/com/example/docs/item/custom/LightningStick.java#item

`use` 事件可能是最有用的事件之一：你可以利用这个事件来召唤闪电。下面的代码实现了在玩家面向的方向前 10 个方块的位置生成闪电。

<<< @/reference/26.2/src/main/java/com/example/docs/item/custom/LightningStick.java#use
